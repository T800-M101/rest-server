...
const { getProducts, getProductById, createProduct, deleteProduct, setProduct } = require('../controllers');
const { validateProductById, validateCategoryById, validateProductName } = require('../helpers');
